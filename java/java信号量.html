...
<html>
	<head>
        ...
        <link rel='stylesheet' id='decode-style-css'  href='http://zhanmaozi.github.io/css/decode.css' type='text/css' media='all' />
        <title>java信号量</title>
	...
	<body>
		...
		<div class="site-branding">		
			<h1 class="site-title">
			<a href="http://zhanmaozi.github.io/" title="寻欢" rel="home">寻欢</a>
			</h1>				
			<h2 class="site-description">润物无声</h2>
		</div>
		</header>
		<p/><p/><p/>
   <h1 class="site-title">java信号量</h1>
		<p/><p/>
...
##业务希望能提高速度，于是改进办法：
采用newCachedThreadPool线程池，结果是速度快了，因为推送的tomcat和主项目公用一台服务器，用了线程池之后，速度提高了但是影响了主项目的响应速度，于是放弃,天无绝人之路，重在思考。
